...
json create_output_sensor_data(const sensor_data& sensor_input, const control_data& ctrl_data) {
    ...
    {"heater_1", check_bitmask(ctrl_data.heaters_cooler, HEATER_1)},
    {"heater_2", check_bitmask(ctrl_data.heaters_cooler, HEATER_2)},
    {"heater_3", check_bitmask(ctrl_data.heaters_cooler, HEATER_3)},
    {"cooler", check_bitmask(ctrl_data.heaters_cooler, COOLER)},
